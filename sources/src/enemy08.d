	...
	switch(TskBuf[id].step){
		case	0:	// init
			...
			if(TskBuf[id].tskid & TSKID_POSSET){
				...
				if((Rand() % 100) > 50){
					TskBuf[id].px = -160.0f + (Rand() % 64) - 32;
				}else{
					TskBuf[id].px = +160.0f + (Rand() % 64) - 32;
				}
			...
			setTSKoption(id, TskBuf[id].level, BULLET_ZAKO08);
		...
		case	1:	// first-move
			...
			if(waitEnemyStep2(id, &TSKenemy08Int)){
		...
		case	100:
			...
			effSetBrokenBody(id, broken_poly, 3*0, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*1, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*2, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*3, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*4, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*5, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*6, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenBody(id, broken_poly, 3*7, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*0, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*1, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*2, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*3, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*4, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*5, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*6, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			effSetBrokenLine(id, broken_poly, 3*7, 3,+0.0f,+0.0f,+3.0f,+3.0f);
			TskBuf[id].step = -1;
			break;
...
void TSKenemy08Draw(int id)
{
	...
	for(int i = 0; i < 10; i++) setVertex(id, i);
	glEnd();
	glColor4f(1.0f,1.0f,1.0f,TskBuf[id].alpha);
	glBegin(GL_LINE_LOOP);
	for(int i = 1; i < 3; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 2; i < 4; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 3; i < 5; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 4; i < 6; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 5; i < 7; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 6; i < 8; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 7; i < 9; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
	glBegin(GL_LINE_LOOP);
	for(int i = 8; i < 10; i++) setVertex(id, i);
	setVertex(id, 0);
	glEnd();
}
